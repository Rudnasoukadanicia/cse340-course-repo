...
if (!process.env.DB_URL) {
    console.warn('Warning: DB_URL is not set. PostgreSQL connection will use default environment behavior and may fail if the database is not running locally.');
}
